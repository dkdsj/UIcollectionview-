...
@interface CCCTagView ()
<UICollectionViewDataSource, UICollectionViewDelegate, MyCCCLayoutProtocol>
@property (nonatomic, strong) NSMutableArray *items;
@property (nonatomic, strong) CCCTagLayout *myLayout;
@property (nonatomic, strong) UICollectionView *cv;
@end

@implementation CCCTagView
...
- (void)cccTageViewConfig:(NSArray *)array {
