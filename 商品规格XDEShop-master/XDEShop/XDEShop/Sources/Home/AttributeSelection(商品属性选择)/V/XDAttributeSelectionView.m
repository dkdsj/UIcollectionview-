...
#import "XDCollectionViewLayout.h"
...
- (void)createInterface {
    ...
    self.collectionView.frame = CGRectMake(0, self.tableView.bottom ,HPScreenWidth , NowScreenH - 200 - _bottomSpace-HPSafeAreaBottomHeight);
...
- (void)setupBottomView {
    ...
    NSLog(@"HPSafeAreaBottomHeight=%d", HPSafeAreaBottomHeight);
    
    NSArray *titles = @[@"确 定", @"确1定", @"确2定"];
    CGFloat buttonH = 50;
    CGFloat buttonW = HPScreenWidth / titles.count;
    CGFloat buttonY = HPScreenHeight - _bottomSpace - buttonH-HPSafeAreaBottomHeight;
    ...
    numLabel.frame = CGRectMake(10, HPScreenHeight - _bottomSpace - 90-HPSafeAreaBottomHeight, 70, 35);
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        XDCollectionViewLayout *layout = [XDCollectionViewLayout new];
